<template>
  <div>
     <div class="mt-20">
            <h1 class="flex items-center justify-center font-bold text-pink-600 text-md lg:text-3xl">Checkout</h1>
        </div>
                        ...
                        <div class="">
                            <div class="space-x-0 lg:flex lg:space-x-4">
                                ...
                                <div class="w-full lg:w-1/2 ">
                                    ...
                                    <input name="Last Name" type="text" placeholder="Sobrenome"
                                        class="w-full px-4 py-3 text-sm border border-gray-300 rounded lg:text-sm focus:outline-none focus:ring-1 focus:ring-blue-600">
                                </div>
                            </div>
                            <div class="mt-4">
                                <div class="w-full">
                                    <label for="Email"
                                        class="block mb-3 text-sm font-semibold text-gray-500">E-mail</label>
                                    <input name="Last Name" type="text" placeholder="E-mail"
                                        class="w-full px-4 py-3 text-sm border border-gray-300 rounded lg:text-sm focus:outline-none focus:ring-1 focus:ring-blue-600">
                                </div>
                            </div>
                            <div class="mt-4">
                                <div class="w-full">
                                    ...
                                    <textarea
                                        ...
                                        name="Address" cols="20" rows="4" placeholder="Endereço"></textarea>
                                </div>
                            </div>
                            <div class="space-x-0 lg:flex lg:space-x-4">
                                <div class="w-full lg:w-1/2">
                                    <label for="city"
                                        class="block mb-3 text-sm font-semibold text-gray-500">Cidade</label>
